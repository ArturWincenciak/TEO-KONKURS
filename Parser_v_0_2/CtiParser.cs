...
namespace v_0_2
{
    public class CtiParser : ICtiParser
    {
        public CtiEvent Parse(string input)
        {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.RINGING)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.HANGUP)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.HOLD)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.LINK)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.UN_LINK)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.PEER_STATUS)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.SESSION_CLOSE)
            {
            ...
            if (firstLine == CtiProtocol.PropertyType.EVENT + ": " + CtiProtocol.EventType.TRAYING)
            {
